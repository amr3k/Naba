    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo url('admin/login'); ?>"><b>Admin</b>LTE</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg">Sign in to start your session</p>

                <form action="<?php echo url('admin/login/submit'); ?>" id="login-form" method="post">
                        ...
                        $('#login-form').on('submit', function (e) {
                            ...
                            $.ajax({
                                ...
                                beforeSend: function () {
                                    ...
                                    loginResults.removeClass().addClass('alert alert-info').html('Logging in ..');
                                },
